<template>
  <div class="m-life">
    <el-row>
      <el-col :span="12"><slider/></el-col>
      <el-col :span="4"><div style="padding-left: 8px;"><div class="m-life-pic"></div></div></el-col>
      <el-col :span="6">
        <div class="m-life-login">
          ...
          <p><nuxt-link to="/register"><el-button
            round size="medium">注册</el-button></nuxt-link></p>
          <p><nuxt-link to="/login"><el-button
            round size="medium">立即登录</el-button></nuxt-link></p>
        </div>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="6"><div class="m-life-hotel"/></el-col>
      <el-col :span="6"><div class="m-life-music"/></el-col>
      <el-col :span="4"><div style="padding-left: 8px;"><div class="m-life-coop"/></div></el-col>
      <el-col :span="6">
